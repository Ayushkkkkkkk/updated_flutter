        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset('assets/icons/home-colored-p.png',
                  height: 50.0), // Replace with your home icon image asset path
          ...
          Padding(
            padding: const EdgeInsets.symmetric(
                horizontal: 15.0), // Adjust margin values as needed
            child: Text(
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  shape: RoundedRectangleBorder(
                    borderRadius:
                        BorderRadius.circular(10.0), // 10px border radius
                  ),
                ),
              ),
              SizedBox(width: 10.0),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        fixedSize:
                            Size(MediaQuery.of(context).size.width * 0.46, 50),
                        shape: RoundedRectangleBorder(
  ...
  Widget buildCommuteForm(CommuteForm form) {
    return Column(
      children: [
        ...
        Padding(
          padding: const EdgeInsets.symmetric(
              horizontal: 10.0), // Adjust margin values as needed
          child: Row(
            children: [
              Expanded(
                child: TextField(
